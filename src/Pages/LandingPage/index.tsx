...
import { Box, Button, CircularProgress, Grid, MenuItem, Modal, Paper, Select, Tab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tabs, TextField, Typography, } from "@mui/material";
...
const LandingPage = () => {
  ...
  const [isShiftCategoryModalOpen, setIsShiftCategoryModalOpen] = useState(false);
  const [shiftedCategory, setShiftedCategory] = useState<any>(null);
  const [historyData, setHistoryData] = useState<any>([]);
  const [isEntertainmentDeleteDisabled, setIsEntertainmentDeleteDisabled] = useState(true);
  const [isEducationDeleteDisabled, setIsEducationDeleteDisabled] = useState(true);
  const [isMotivationDeleteDisabled, setIsMotivationDeleteDisabled] = useState(true);
            ...
            <React.Fragment>
              ...
              >
                ...
                <Grid container item>
                  ...
                  >
                   <strong> <h6>Add entertainment card </h6></strong>                  </Button>
                  <Button style={{backgroundColor:"grey"}}
                    sx={{
                      marginBottom: 4,
                      marginLeft: 4,
                  ...
                  >
                    <strong><h6>Delete selected</h6></strong>
                  </Button>
                  <CardList
                ...
                <Grid container item>
                  ...
                  <Button style={{backgroundColor:"grey"}}
                    ...
                    sx={{ marginBottom: 4, marginLeft: 4 }}
                  >
                    <strong><h5>Add education card</h5></strong>
                  </Button>
                  <Button style={{backgroundColor:"grey"}}
                    sx={{
                      marginBottom: 4,
                ...
                <Grid container item>
                  ...
                  <Button style={{backgroundColor:"grey"}}
                    ...
                    sx={{ marginBottom: 4, marginLeft: 4 }}
                  >
                   <strong><h6> Add motivation card </h6></strong>
                  </Button>
                  <Button style={{backgroundColor:"grey"}}
                    sx={{
                      marginBottom: 4,
